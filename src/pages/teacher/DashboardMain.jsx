            ...
            <TopNavigationBar>
                ...
                <div className="right">
                    <Tooltip title="Account settings">
                        ...
                        >
                            <Avatar sx={{ width: 32, height: 32 }}>{getSimpleCapitalizedChars(JSON.parse(localStorage.getItem('teaData')).fullName)}</Avatar>
                        </IconButton>
                    </Tooltip>
                </div>
                <Menu
                ...
                >
                    ...
                    <Avatar sx={{ width: 32, height: 32 }}>{getSimpleCapitalizedChars(JSON.parse(localStorage.getItem('teaData')).userName)}</Avatar>
