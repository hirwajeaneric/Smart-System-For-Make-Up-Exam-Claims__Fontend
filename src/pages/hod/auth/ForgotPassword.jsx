...
const ForgotPassword = () => {
  ...
  return (
    <HorizontallyFlexSpaceBetweenContainer style={{ justifyContent: 'center', alignItems: 'center' }}>
      <Helmet>
        <title>Head of Department - Forgot password</title>
      ...
      <AuthenticationFormContainer style={{ borderBottom: '6px solid chocolate',gap: '30px', position: 'relative', boxShadow: 'rgba(0, 0, 0, 0.05) 0 6px 24px, rgba(0, 0, 0, 0.08) 0 5px 12px 1px' }}>
        ...
        <VerticallyFlexGapForm style={{ gap: '20px'}} onSubmit={handleSubmit(onSubmit)}>
          ...
          <HorizontallyFlexSpaceBetweenContainer>
            <Link style={{ color: 'gray', fontSize:'90%', textAlign: 'center', textDecoration: 'none' }} to={'/HOD/auth/signin'}>I can't recover my account using this page</Link>
          </HorizontallyFlexSpaceBetweenContainer>
