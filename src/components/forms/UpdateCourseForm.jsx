...
export default function UpdateCourseForm({projectId}) {
    ...
    return (
        <VerticallyFlexGapForm onSubmit={handleSubmit(onSubmit)} style={{ gap: '20px', backgroundColor: 'white', padding: '0 10px 20px' }}>
